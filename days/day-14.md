...
## Intent
Perform an adversarial pass: where will this fail, what assumptions are hidden, and which flows are brittle? Fix only evidenced issues.
...
## Outputs
- A stronger product and a challenge evidence record.
- `evidence/day-14.md`
